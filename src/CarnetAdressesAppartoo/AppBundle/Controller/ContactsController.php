...
use CarnetAdressesAppartoo\AppBundle\Form\AddressBookType;


/**
 * Contrôleur de la page des contacts de l'utilisateur connecté.
 */
class ContactsController extends ContainerAware {
    ...
    public function showAction() {
        ...
        $book = $em->getRepository('CarnetAdressesAppartooAppBundle:AddressBook')->findAddressBookOf($user);
        ...
        if ($book->isEmpty()) {
            ...
            $qb = $em->getRepository('CarnetAdressesAppartooUserBundle:User')
        ...
        return $this->container->get('templating')
                        ->renderResponse('CarnetAdressesAppartooAppBundle:Front:contacts.html.twig', array (
    ...
    public function deleteAction(Request $request) {
        ...
        $qb = $em->getRepository('CarnetAdressesAppartooUserBundle:User')->createQueryBuilder('u')
        ...
        if ($form->isValid()) {
            ...
            foreach ($data as $id) {
                ...
                $session->getFlashBag()->add('Confirmation', $contact->getUsername().' a été supprimé de vos amis.');
